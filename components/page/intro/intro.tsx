...
const Intro: React.FC = () => {
    ...
    return <div className={'origin-center w-full relative h-screen bg-neutral-900 overflow-x-hidden overflow-y-hidden'} ref={mainRef}>
        <div className={"relative min-w-max min-h-max translate-x-1/2 translate-y-1/2 z-10"}>
            ...
            <Flat height={450} width={150} left={0} top={350} delay={0.9} randPosX={40} depth={0}/>
            <Flat height={200} width={100} left={-100} top={380} delay={0.2} randPosX={20} depth={2}/>

            <Flat height={430} width={220} left={500} top={300} delay={0.9} randPosX={10} depth={3}/>
            <Flat height={200} width={100} left={700} top={400} delay={0.2} randPosX={40} depth={0}/>
